...
public class SJTView extends Activity
{
	TabHost th;
	ListView veglist, nonlist, chineselist;
	MyCursorAdapter vegAdap, nonAdap, chiAdap;
	Data database;
	MyListHandler handler = new MyListHandler(SJTView.this);
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.list_sjt);
		...
		// Setting up of list
		database = new Data(SJTView.this);
		database.open();

		cVeg = database.getdata(Data.DATABASE_VEG, Data.KEY_SJT);
		cVeg.moveToFirst();
		cNon = database.getdata(Data.DATABASE_NONVEG, Data.KEY_SJT);
		cNon.moveToFirst();
		cChinese = database.getdata(Data.DATABASE_CHINESE, Data.KEY_SJT);
		...
		vegAdap = new MyCursorAdapter(SJTView.this, cVeg);
		nonAdap = new MyCursorAdapter(SJTView.this, cNon);
		chiAdap = new MyCursorAdapter(SJTView.this, cChinese);
	...
	public void onBackPressed()
	{
		...
		AlertDialog.Builder dialog = new AlertDialog.Builder(SJTView.this);
		...
		dialog.setPositiveButton("Ya, I am Done",
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which)
					{
						...
						try
						{
							i = new Intent(SJTView.this, Class
