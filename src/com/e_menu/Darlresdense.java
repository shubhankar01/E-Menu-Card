...
public class Darlresdense extends Activity
{
	TabHost th;
	ListView veglist, nonlist, chineselist;
	MyCursorAdapter vegAdap, nonAdap, chiAdap;
	Data database;
	MyListHandler handler = new MyListHandler(Darlresdense.this);
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.list_darl);
		...
		// Setting up of list
		database = new Data(Darlresdense.this);
		database.open();

		cVeg = database.getdata(Data.DATABASE_VEG, Data.KEY_FM);
		cVeg.moveToFirst();
		cNon = database.getdata(Data.DATABASE_NONVEG, Data.KEY_FM);
		cNon.moveToFirst();
		cChinese = database.getdata(Data.DATABASE_CHINESE, Data.KEY_FM);
		...
		vegAdap = new MyCursorAdapter(Darlresdense.this, cVeg);
		nonAdap = new MyCursorAdapter(Darlresdense.this, cNon);
		chiAdap = new MyCursorAdapter(Darlresdense.this, cChinese);
	...
	public void onBackPressed()
	{
		...
		AlertDialog.Builder dialog = new AlertDialog.Builder(Darlresdense.this);
		...
		dialog.setPositiveButton("Ya, I am Done",
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which)
					{
						...
						try
						{
							i = new Intent(Darlresdense.this, Class
